               ...
               <div className={styles.contact}>
                    ...
                    <div className={styles.details}>
                         <div className={styles.info}>        
                              <p><PhoneFilled className={styles.icon} style={{color: "#0f9d58"}}/>(+84) 773 288 148</p>
                         </div>
                         <div className={styles.info}>
                              <p><MailFilled className={styles.icon} style={{color: "#FF3333"}} />dsc.dut@gmail.com</p>
                         </div>
                         <div className={styles.info}>
                              <p><FacebookFilled className={styles.icon} style={{color: "#4267B2"}} />facebook.com/dscdut</p>  
                         </div>   
                    </div>
               </div>
